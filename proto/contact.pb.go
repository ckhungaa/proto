...
func (m *GetContactsByOwnerIdRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetContactsByOwnerIdRequest.Merge(m, src)
}
...
func (m *GetContactsByOwnerIdResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetContactsByOwnerIdResponse.Merge(m, src)
}
...
func (m *CallHistoryResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CallHistoryResponse.Merge(m, src)
}
...
func (*UnimplementedContactServiceServer) GetContactById(ctx context.Context, req *GetContactByIdRequest) (*ContactResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetContactById not implemented")
}
func (*UnimplementedContactServiceServer) GetContactsByOwnerId(ctx context.Context, req *GetContactsByOwnerIdRequest) (*GetContactsByOwnerIdResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetContactsByOwnerId not implemented")
}
